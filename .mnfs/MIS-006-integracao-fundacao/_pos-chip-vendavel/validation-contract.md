...
| VC-2 | Linha "Resultado: N de M" do card e chip "Vendáveis N de M" do catálogo batem com SQL rodando a MESMA regra no mesmo banco (N≈3.822 na base atual, tolerância de drift) | contagem DOM + query e resultado colados |
