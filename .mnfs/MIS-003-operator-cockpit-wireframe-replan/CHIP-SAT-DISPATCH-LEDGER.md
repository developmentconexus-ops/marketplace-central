...
| 20 | Implement F01-D1 orders dashboard counters | gpt-5.6-luna / high | OS-process | scratchpad/prompt-f01-d1.md | scratchpad/agent__f01-d1.log · agent__f01-d1.last.md | dispatched | pending |
| 19 | Implement F01-D3 last-sync projection | gpt-5.6-luna / high | OS-process | scratchpad/prompt-f01-d3.md | scratchpad/agent__f01-d3.log · agent__f01-d3.last.md | dispatched | pending |
