...
| D6 — Frontend | **ACCEPTED / CLOSED; NOTIF-01 D6-R DESIGN APPROVED / P8 REVIEW NEXT** |
...
| D6-R2 — Complete Frontend Realization Closure | **OPEN / ACTIVE — B00/B01 LOCKED; B10 SUSPENDED; NOTIF-01 D6-R WRITTEN REVIEW** |
...
- D6-R approved direction: topbar bell + bounded preview; full Inbox utility route outside sidebar; `Configurações > Notificações` fixed 10-route inline editor; no implicit mark-read, no new API/Permission.
- D6-R remains **P8 NOT LOCKED** until rendered executable HTML is visually adjudicated by the operator.
