...
| D6-R2 authority | [D6-R2 Closure](engineering/rebaseline/D6-R2-COMPLETE-FRONTEND-REALIZATION-CLOSURE.md) + [P5 Inventory](engineering/rebaseline/D6-R2-P5-SCREEN-SURFACE-INVENTORY.md) + [P8 Ledger](engineering/rebaseline/D6-R2-P8-BLOCK-LEDGER.md) + [B10 P6 Study](engineering/rebaseline/D6-R2-P6-B10-PREPARATION-REFERENCE-STUDY.md) — **P0–P5 DERIVED; B00 + B01 LOCKED; B10 P6 DERIVED; P7 NOT TRIGGERED** |
...
| Exact next action | **Render one executable low-fi HTML B10 Preparation CANDIDATE using search/list → selected exact-subject detail. Preserve B00 shell and exact Installation context. No P7 alternatives; no Product implementation.** |
...
| D6-R2 — Complete Frontend Realization Closure | **OPEN / ACTIVE — B00 + B01 LOCKED; B10 P6 DERIVED** |
...
- A04 remains locked as contextual priority: actionable Work leads; known-empty Work collapses without implying health; unavailable/unknown Work remains explicit; marketplace/Performance/Economics orientation stays visible.
- B10 P6 studied Google Merchant Center, Akeneo, Amazon Seller Central and Mirakl/Lowe's. Reference evidence converged on **search/list triage → selected exact-subject detail** for material readiness/correction.
- B10 permanent split-view and full inline material correction are rejected as baseline; **P7 is NOT TRIGGERED**.
- No Product operation, Permission, owner, bulk capability, readiness score or hidden source default was invented.
