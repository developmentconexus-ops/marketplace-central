...
| D6-R2 | [Closure](engineering/rebaseline/D6-R2-COMPLETE-FRONTEND-REALIZATION-CLOSURE.md) + [P4-R1](engineering/rebaseline/D6-R2-P4-R1-GLOBAL-IA-OPERATIONAL-MASS-REOPEN.md) + [P8](engineering/rebaseline/D6-R2-P8-BLOCK-LEDGER.md) + [B110](engineering/rebaseline/D6-R2-P8-B110-APPROVALS-CANDIDATE.md) + [B10 P6](engineering/rebaseline/D6-R2-P6-B10-PREPARATION-REFERENCE-STUDY.md) — **B00/B01/B00-R2/B11/B12 LOCKED; B110 RENDERED CANDIDATE; B10 SUSPENDED; P9 BLOCKED BY B110 LOCK** |
...
| Exact next action | **Operator visually adjudicates B110 only. P9 requires B110 `LOCK`; then Fable review/adjudication. B10/D7-R/D8-R remain blocked.** |
...
| D6 — Frontend | **ACCEPTED / CLOSED baseline; B110 visual review before final P9** |
...
| D6-R2 — Complete Frontend Realization Closure | **OPEN / ACTIVE — B110 RENDERED CANDIDATE / VISUAL ADJUDICATION REQUIRED** |
...
- D5-R6 AuthorizationRequest wire is canonical; B110 P8 is technically GREEN and **not operator-LOCKED**.
