...
**Continue D0 with the operator: D0.7e — define the ERP-independent enterprise/legal/fiscal operating scope needed by MPC.**

Accepted D0.1–D0.6 decisions plus D0.7a essential post-sale, D0.7b shipment/delivery lifecycle, D0.7c automatic marketplace availability control, D0.7d `Organization 1 → N Marketplace Installations`, and D0.7e's ERP-agnostic semantic-translation principle are recorded in `docs/engineering/rebaseline/D0-PRODUCT-SYSTEM-DEFINITION.md`.

D0.7e explicitly prohibits designing the MPC canonical domain by copying Sankhya-native constructs such as `CODEMP`, `CODLOC`, cost variants or other ERP-specific structures. First define the business semantic MPC needs; later D2/D4 map Sankhya or another ERP into that semantic.
...
- D0.1–D0.6 and D0.7a–D0.7e recorded in the D0 artifact are operator-approved decisions/principles;
