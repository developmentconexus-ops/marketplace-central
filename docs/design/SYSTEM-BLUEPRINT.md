...
| 3. Rebuild mirror | snapshot do protocolo | estado corrente por codigo_produto | `products_mirror` (+ stock_locations) |
...
o parser leniente existente + rebuild mirror + cadeia vínculo automático + tela /importacoes com
