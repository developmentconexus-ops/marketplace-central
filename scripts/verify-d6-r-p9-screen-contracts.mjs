...
assert(doc.includes('P9_DECISION_CONCURRENCY:IF_MATCH_AUTHORIZATION_REQUEST'), 'decision concurrency must use AuthorizationRequest If-Match');
...
assert(doc.includes('D7-R remains BLOCKED'), 'P9 must not authorize D7-R before Fable');
